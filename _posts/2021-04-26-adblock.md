---
layout: post
title: Block annoying ads in android without root!
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="/assets/img/blogs/adblock/threedots.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="/assets/img/blogs/adblock/addons.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="/assets/img/blogs/adblock/uBlockOrigin.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
Go to Add-ons from the three-dot menu option. Look for the uBlock Origin add-on and click the + button on the right. There you go for an add-less experience on your browser. The only catch is you will have to browse websites and articles and watch youtube videos on your Firefox browser. At first, it may seem inconvenient, but believe me, you will get used to it in a day. After all, a tiny sacrifice to get rid of ads on youtube!
